...
Public Class RevGeneratorVB
    ...
    'No hashtables in vb use Dictionary instead
    ...
    Private Sub btnGenMissedSch_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnGenMissedSch.Click
        ...
        Try
            'Create a new File for schedule text box, to var file
            'Create a new File for the missed schedule, to var file2
            '
            'fileSize = 'file.length() + file2.length()
            'ProgBar.Maximum = fileSize

            'Function Worker call need to find way around this
            '
        Catch ex As Exception
            System.Console.WriteLine("Error: " & ex.Message)
        End Try
    ...
    Private Sub btnGenSch_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnGenSch.Click
        ...
        Try
            'Create a new File for schedule text box, to var file
            'Create a new File for lookup text box, to var file2
            '
            'fileSize = 'file.length() + file2.length()
            'ProgBar.Maximum = fileSize
    ...
    'Accepts: a string contianing the description of thta schedule time
    ...
    Public Sub writeErrorLog()
        Try
            If Not missedScheduleMap.Count = 0 Then
                ...
                'For idx As Integer missedScheduleMap. 
